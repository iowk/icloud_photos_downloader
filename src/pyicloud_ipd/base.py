        ...
        if not login_successful:
            ...
            class SrpPassword():
                ...
                def encode(self):
                    ...
                    key_length = 32
                    return hashlib.pbkdf2_hmac('sha256', password_hash, self.salt, self.iterations, key_length)
            ...
            try:
                ...
                if "serviceErrors" in response.json():
                    raise PyiCloudAPIResponseException(response.json()["serviceErrors"])
